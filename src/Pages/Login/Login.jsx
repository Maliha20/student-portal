      ...
      <div className="form-control w-96">
        ...
        <div className="form-control w-96">
          ...
          <p className="mt-4" onClick={()=> setShow(!show)}>
                {
                    show ? <FaEyeSlash className="text-orange-50"></FaEyeSlash> : <FaEye className="text-orange-50"></FaEye>
                }
            </p>
            <p className="text-orange-50">{error}</p>
            <p className="text-orange-50">{success}</p>
             <div className="flex justify-between">
             <p className="text-orange-50">New here? <Link className="text-yellow-500" to="/signup">Create an account</Link></p>
             <input  className="btn btn-warning w-24" type="submit" value="Login" />
             </div>
        </div>
      </form>
      </div>
